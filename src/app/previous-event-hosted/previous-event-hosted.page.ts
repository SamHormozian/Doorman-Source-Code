...
@Component({
  selector: 'app-previous-event-hosted',
  templateUrl: './previous-event-hosted.page.html',
  styleUrls: ['./previous-event-hosted.page.scss'],
})
export class PreviousEventHostedPage implements OnInit {
  userId: any="";
  eventLists:any = [];
  constructor(
