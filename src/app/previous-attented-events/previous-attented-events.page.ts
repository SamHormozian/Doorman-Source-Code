...
@Component({
  selector: 'app-previous-attented-events',
  templateUrl: './previous-attented-events.page.html',
  styleUrls: ['./previous-attented-events.page.scss'],
})
export class PreviousAttentedEventsPage implements OnInit {
  userId: any="";
  eventLists:any = [];
  constructor(
