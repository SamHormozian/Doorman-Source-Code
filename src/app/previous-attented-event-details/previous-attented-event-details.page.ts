...
@Component({
  selector: 'app-previous-attented-event-details',
  templateUrl: './previous-attented-event-details.page.html',
  styleUrls: ['./previous-attented-event-details.page.scss'],
})
export class PreviousAttentedEventDetailsPage {
